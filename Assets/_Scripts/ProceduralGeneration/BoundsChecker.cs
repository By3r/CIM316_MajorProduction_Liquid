...
namespace _Scripts.ProceduralGeneration
{
    ...
    public class BoundsChecker : MonoBehaviour
    {
        ...
        [Header("Debug Info")]
        [SerializeField] private List<ConnectionSocket> _cachedSockets = new List<ConnectionSocket>();
        [SerializeField] private List<Vector3> _socketPositionsBeforeAdjustment = new List<Vector3>();
