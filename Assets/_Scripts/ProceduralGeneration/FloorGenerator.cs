...
namespace _Scripts.ProceduralGeneration
{
    ...
    public class FloorGenerator : MonoBehaviour
    {
        ...
        [Header("Runtime Info")]
        [SerializeField] private List<GameObject> _spawnedRooms = new List<GameObject>();
        [SerializeField] private List<GameObject> _spawnedBlockades = new List<GameObject>();
        [SerializeField] private List<ConnectionSocket> _availableSockets = new List<ConnectionSocket>();
        [SerializeField] private int _connectionsMade = 0;
        [SerializeField] private int _creditsRemaining = 0;
        [SerializeField] private int _blockadeSpawnCount = 0;
