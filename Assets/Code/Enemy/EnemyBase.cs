...
public abstract class EnemyBase : MonoBehaviour
{
    ...
    protected bool RequestPath(Vector3 destination)
    {
        ...
        List<Vector3> newPath = GridPathfinder.Instance.FindPath(transform.position, destination);
    ...
    protected void FollowPath()
    {
        ...
        Vector3 flatTarget = new Vector3(targetPoint.x, transform.position.y, targetPoint.z);
        ...
        if (distance <= waypointTolerance)
        {
            ...
            flatTarget = new Vector3(targetPoint.x, transform.position.y, targetPoint.z);
            direction = flatTarget - transform.position;
        ...
        {
            Vector3 newForward = Vector3.Slerp(transform.forward, direction, turnSpeed * Time.deltaTime);
            newForward.y = 0f;
